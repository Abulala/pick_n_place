...
//  Eigen::Quaterniond grip(0.7, 0.2, 0.7, -0.2);
  start_p.orientation.x = grip.x();
  start_p.orientation.y = grip.y();
  start_p.orientation.z = grip.z();
  start_p.orientation.w = grip.w();
  low_p1.position.x = 0.12; //0.05
  low_p1.position.y = 0.25; //0.25
  low_p1.position.z = -0.1; // -0.1
  low_p1.orientation = start_p.orientation;
  low_p2.position.x = 0.12; //-0.05
  low_p2.position.y = 0.25; // 0.25
  low_p2.position.z = -0.1; // -0.1
  low_p2.orientation = start_p.orientation;
//  Eigen::Quaterniond grip2(0.6851, 0.1749, 0.6851, -0.1749);
